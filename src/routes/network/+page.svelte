...
<main>
  <div class="container">
    ...
    <div class="header">
      <div class="label">Game 3</div>
      <h1>Word Web</h1>
      <p class="description">
        A politically charged word appears at the center. Around it float related words —
        emotions, associations, context. Click every word you'd connect to it.
      </p>
      <p class="description">
        At the end, you'll see what your choices reveal about how you frame political language —
        and how the other side frames it differently.
      </p>
    </div>
